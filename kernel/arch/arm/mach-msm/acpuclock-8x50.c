...
struct clkctl_acpu_speed acpu_freq_tbl_768[] = {
	...
	{ 1, 1036800, ACPU_PLL_3, 0, 0, 0, 0, 128000, 1, 0x1b, 1375},
	{ 1, 1075200, ACPU_PLL_3, 0, 0, 0, 0, 128000, 1, 0x1c, 1400},
	{ 1, 1113600, ACPU_PLL_3, 0, 0, 0, 0, 128000, 1, 0x1d, 1425},
	{ 1, 1152000, ACPU_PLL_3, 0, 0, 0, 0, 128000, 1, 0x1e, 1450},
	{ 1, 1190400, ACPU_PLL_3, 0, 0, 0, 0, 128000, 1, 0x1f, 1475},
...
static void __init acpuclk_init(void)
{
	...
	/* Init speed as default ACPU freq setting*/
	...
	case 1: /* unbuffered scorpion pll (384Mhz to 998.4Mhz) */
		...
		for (speed = acpu_freq_tbl; speed->acpuclk_khz != 0; speed++) {
			if (speed->sc_l_value == sel &&
				...
				break;
			/* Adopt the last speed if the next speed over max clk. 
			if ((speed+1)->acpuclk_khz == 0){
				pr_err("There's no valid setting under max acpu freq. table! Set speed to nearest ACPU setting!\n");
				break;
			}*/
		}
		break;
