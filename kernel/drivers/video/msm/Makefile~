...
obj-$(CONFIG_FB_MSM_MDDI_SAMSUNG_QVGA_LCD) += mddi_samsung_qvga.o
obj-$(CONFIG_FB_MSM_MDDI_HITACHI_QVGA_LCD) += mddi_hitachi_qvga.o
obj-$(CONFIG_FB_MSM_MDDI_TOSHIBA_HVGA_LCD) += mddi_toshiba_hvga.o
obj-$(CONFIG_FB_MSM_MDDI_HITACHI_HVGA_LCD) += mddi_hitachi_hvga.o
endif

obj-$(CONFIG_FB_MSM_LCDC_PANEL) += lcdc_panel.o
obj-$(CONFIG_FB_MSM_LCDC_PRISM_WVGA) += lcdc_prism.o
obj-$(CONFIG_FB_MSM_LCDC_AUO_WVGA) += lcdc_auo.o
